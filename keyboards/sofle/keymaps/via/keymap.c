...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    OSM(MOD_LSFT),  LCA_T(KC_Z),  KC_X,    KC_C,    KC_V,    KC_B,     C(KC_X),         KC_MPLY,   KC_N,    KC_M,    KC_COMM, KC_DOT, LCA_T(KC_SLSH),OSM(MOD_LSFT),
                          KC_LGUI, KC_TRNS, LALT_T(KC_NO),   MO(_NUM), LSFT_T(KC_SPC),  LT(_NUM, KC_SPC), LT(_NAV,KC_BSPC), RALT_T(KC_NO), KC_ENT, KC_BSLS),
    ...
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,      KC_B,   KC_MUTE,      TG(_GAME), KC_N,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSPC,
                      KC_F9, KC_BSPC, KC_LALT,   MO(_FN4), KC_SPC,         KC_SPC,  LT(_NAV,KC_BSPC), KC_RCTL, EH_LEFT, EH_RGHT),

	[_NUM] = LAYOUT(
    KC_TRNS, KC_F1,   KC_F2,      KC_F3,   KC_F4,       DM_REC1,                            KC_F6,   KC_F7, KC_F8,   KC_F9,  KC_F10,  KC_F11,
    KC_CAPS, KC_TRNS, M_ARROW,    KC_LBRC, KC_RBRC,     DM_RSTP,                            KC_PCMM, KC_P7, KC_P8,   KC_P9,  KC_PAST, KC_F12,
    KC_TRNS, KC_LCBR, KC_RCBR,    KC_LPRN, KC_RPRN,     DM_PLY1,                            KC_PDOT, KC_P4, KC_P5,   KC_P6,  KC_PMNS, KC_PPLS,
    KC_TRNS, KC_TRNS, A(KC_X),    A(KC_C), A( KC_V),    A(KC_B), KC_SLEP,         TG(_GAME), KC_TRNS, KC_P1, KC_P2,   KC_P3,  KC_PSLS, KC_PENT,
    ...
    KC_TRNS, KC_TRNS,    M_SLCT,  KC_MS_U, KC_BTN2, KC_TRNS,                             KC_DEL,     KC_HOME,  KC_END,  KC_TRNS,    KC_INS,  KC_PGUP,
    KC_TRNS, KC_BTN2,    KC_MS_L, KC_MS_D, KC_MS_R, KC_TRNS,                             KC_LEFT,    KC_DOWN,  KC_UP,   KC_RGHT,    KC_ENT,  KC_PGDN,
    KC_TRNS, KC_TRNS,    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PWR,            KC_TRNS, C(KC_LEFT), KC_TRNS,  KC_TRNS, C(KC_RGHT), KC_TRNS, KC_TRNS,
    ...
    TG(_FN4), KC_NO, KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS,                           KC_NO,   KC_VOLD, KC_MUTE, KC_VOLU, KC_NO, KC_NO,
    KC_NO,    KC_NO, KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,        TG(_FN4), KC_NO,   KC_MPRV, KC_MPLY, KC_MNXT, KC_NO, KC_NO,
