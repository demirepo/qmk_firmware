...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    KC_TAB,        C_S_T(KC_Q),  KC_W,         KC_E,    KC_R,    KC_T,                                  KC_Y,    KC_U,     KC_I,    KC_O,         C_S_T(KC_P),      KC_LBRC,
    KC_ESC,        LCTL_T(KC_A), LALT_T(KC_S), KC_D,    KC_F,    KC_G,                                  KC_H,    KC_J,     KC_K,    RALT_T(KC_L), RCTL_T(KC_SCLN),  KC_QUOT,
    OSM(MOD_LSFT), LCA_T(KC_Z),  KC_X,         KC_C,    KC_V,    KC_B,     KC_MUTE,            KC_MPLY, KC_N,    KC_M,     KC_COMM, KC_DOT,       LCA_T(KC_SLSH),   OSM(MOD_LSFT),
                                 KC_LGUI,      KC_LALT, KC_LCTL, MO(_NUM), LSFT_T(KC_SPC),     LT(_NAV, KC_SPC), MO(_NAV), KC_BSPC, KC_ENT,       KC_BSLS),

	[_GAME] = LAYOUT(
    KC_GRV,  KC_EXLM, KC_AT,   KC_HASH, KC_DLR,    KC_PERC,                         KC_CIRC,  KC_AMPR, KC_ASTR, KC_BSLS, KC_MINS, KC_EQL,
    KC_ESC,  KC_Q,    KC_W,    KC_F,    KC_P,      KC_G,                            KC_J,     KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_LBRC,
    KC_TAB,  KC_A,    KC_R,    KC_S,    KC_T,      KC_D,                            KC_H,     KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,
    KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,      KC_B,     KC_MUTE,      KC_MPLY, KC_K,     KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_BSPC,
                      KC_LGUI, KC_LALT, KC_LCTL,   MO(_FN4), KC_SFTENT,    KC_SPC,  MO(_NAV), KC_RCTL, KC_RALT, KC_RBRC),

	[_NUM] = LAYOUT(
    KC_TRNS, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                        KC_F6,   KC_F7, KC_F8,   KC_F9,  KC_F10,  KC_F11,
    KC_GRV,  KC_TILD, KC_TRNS, KC_LBRC, KC_RBRC, KC_UNDS,                      KC_PCMM, KC_P7, KC_P8,   KC_P9,  KC_PAST, KC_F12,
    KC_TRNS, KC_LCBR, KC_RCBR, KC_LPRN, KC_RPRN, KC_MINS,                      KC_PDOT, KC_P4, KC_P5,   KC_P6,  KC_PMNS, KC_PPLS,
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_PWR,     TG(4),   KC_TRNS, KC_P1, KC_P2,   KC_P3,  KC_PSLS, KC_PENT,
                      KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,    KC_TRNS, KC_P0,   KC_P0, KC_TRNS, KC_TRNS),

	[_NAV] = LAYOUT(
    KC_TRNS, KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_TRNS,                         KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
    KC_TRNS, KC_ACL0,    KC_BTN1,    KC_MS_U,    KC_BTN2,    KC_TRNS,                         KC_DEL,  KC_HOME, KC_END,  KC_TRNS, KC_INS,  KC_PGUP,
    KC_TRNS, KC_ACL1,    KC_MS_L,    KC_MS_D,    KC_MS_R,    KC_ACL2,                         KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_ENT,  KC_PGDN,
    KC_TRNS, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), KC_TRNS, KC_TRNS,       KC_SLEP, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,
                         KC_TRNS,    KC_TRNS,    KC_TRNS,    KC_BTN1, KC_TRNS,       KC_NO,   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
